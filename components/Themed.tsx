      ...
      style={[
        {
          ...
          fontSize: Layout.defaultTextSize + size,
        },
        style,
      ]}
      {...otherProps}
...
export function Italics(props: TextProps) {
  ...
  return (
    <Text
      style={[{ fontFamily: "Lora-Italic", fontStyle: "italic" }, style]}
      {...otherProps}
    />
  );
}
...
export function LabeledTextInput(
  ...
  return (
    <View
      style={[{ flexDirection: "row", gap: 5, alignItems: "center" }, style]}
    >
      ...
      style={[
        {
          ...
          backgroundColor: useThemeColor(
            { light: "#b4b4b4", dark: "rgba(255,255,255,0.9)" },
            "background"
          ),
        },
        style,
...
export function Title(props: TextProps) {
  ...
  return (
    <Bold
      style={[
        {
          fontSize: Layout.defaultTitleSize + size,
          //fontFamily: "helvetica-bold",
          fontFamily: "Lora-Bold",
        },
        style,
...
export function RoundedButton(
  props: PressableProps & {
    color: keyof (typeof Colors)["light" | "dark"];
    bold?: boolean;
  }
) {
...
export function ListItem(props: ViewProps) {
  return (
    <View style={{ padding: 10, borderBottomWidth: 1 }} {...props}>
      {props.children}
      <Hr />
    </View>
  );
